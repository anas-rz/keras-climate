"""SpaceNet 2 dataset (ported from torchgeo.datasets.spacenet.spacenet2)."""
...
class SpaceNet2(SpaceNet):
    ...
    Collection features (AOI, area km2, # images, # buildings):
    ...
    * PAN: 0.31 GSD, 650 x 650
    * MS: 1.24 GSD, 163 x 163
    * PS-MS: 0.30 GSD, 650 x 650
    * PS-RGB: 0.30 GSD, 650 x 650
