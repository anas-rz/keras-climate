"""European Digital Elevation Model (EU-DEM) dataset (ported from torchgeo.datasets.eudem)."""
...
class EUDEM(RasterDataset):
    ...
    `EU-DEM
    <https://www.eea.europa.eu/en/datahub/datahubitem-view/d08852bc-7b5f-4835-a776-08362e2fbf4b>`__
