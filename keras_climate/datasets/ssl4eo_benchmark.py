"""SSL4EO Landsat Benchmark dataset (ported from torchgeo.datasets.ssl4eo_benchmark)."""
...
class SSL4EOLBenchmark(NonGeoDataset):
    ...
    * https://proceedings.neurips.cc/paper_files/paper/2023/hash/bbf7ee04e2aefec136ecf60e346c2e61-Abstract-Datasets_and_Benchmarks.html
    ...
    valid_classes = {"nlcd": NLCD.valid_classes, "cdl": CDL.valid_classes}
    ...
    def __init__(
        ...
        Args:
            ...
            classes: list of classes to include, the rest will be mapped to
                0 (defaults to all classes for the chosen product)
        ...
        self.ordinal_map = np.zeros(self.valid_classes[product][-1] + 1, dtype="int64")
        self.inverse_map = np.zeros(len(self.classes), dtype="int64")
    ...
    def retrieve_sample_collection(self):
    ...
    def plot(self, sample, show_titles=True, suptitle=None):
        ...
        image = np.take(image, self.rgb_indices[self.sensor], axis=-1)
        image = image / 255
