"""Sentinel datasets (ported from torchgeo.datasets.sentinel)."""
...
class Sentinel1(Sentinel):
    ...
    * VH: vertical transmit, horizontal receive
    ...
    # SAFE format / ASF DAAC GRD RTC naming scheme:
...
class Sentinel2(Sentinel):
    ...
    surface conditions, and its wide swath width (290 km) and high revisit time
    will support monitoring of Earth's surface changes.
    """
    ...
    def plot(self, sample, show_titles=True, suptitle=None):
        ...
        image = ops.clip(image / 10000, 0, 1)
