"""Global Mangrove Watch dataset (ported from torchgeo.datasets.globalmangrovewatch)."""
...
class GlobalMangroveWatch(RasterDataset):
    ...
    The `Global Mangrove Watch <https://www.globalmangrovewatch.org>`__ Version
    3.0 dataset provides maps of global mangrove extent for eleven epochs
    between 1996 and 2020, derived from L-band Synthetic Aperture Radar (SAR)
    and optical (Landsat) satellite data.
    ...
    * Tiled as 1 x 1 degree GeoTIFF files of 4,500 x 4,500 pixels
    ...
    * https://doi.org/10.5281/zenodo.6894273
    ...
    def plot(self, sample, show_titles=True, suptitle=None):
        ...
        panels = [("Mask", mask.reshape(-1, *mask.shape[-2:]))]
